document.addEventListener('DOMContentLoaded', () => {
    ...
    form.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            const checkResponse = await fetch(`https://sysgesbe-production.up.railway.app/api/employee/find/${cedEmployee}`);
        ...
        try {
            const response = await fetch('https://sysgesbe-production.up.railway.app/api/employee/save', {
                method: 'POST',
