document.addEventListener("DOMContentLoaded", () => {
    ...
    form.addEventListener("submit", (e) => {
        ...
        const url = `https://backend.int-solutionstec.com/api/login/findd/${valor}`;
        fetch(url)
            .then(response => {
                if (!response.ok) {
    ...
    confirmYes.addEventListener("click", () => {
        ...
        const url = `https://backend.int-solutionstec.com/api/login/deletee/${pendingDeleteId}`;
    ...
    btnActualizar.addEventListener("click", () => {
        ...
        const payload = { name };
        const url = `https://backend.int-solutionstec.com/api/customer/update/${id}`;
